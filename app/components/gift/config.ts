...
export const CONFIG = {
  ...
  moments: [
    ...
    },
    {
      ...
      text: "Que la vida te llene de éxitos, q aprendas a andar en bici y todo lo que te propongas en esta nueva etapa.",
    },
  ],
  letter: [
    ...
    "",
    "Y tu para mii eres una de ellas.",
    "",
    "Espero que esta nueva etapa",
    "te traiga mucha paz, felicidad",
    "y momentos increíbles.",
    "",
    "Gracias por tantos recuerdos bonitos Cami,",
