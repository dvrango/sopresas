...
export const CONFIG = {
  ...
  letter: [
    ...
    "y que esto te saque una sonrisa y me recuerdes con cariño.",
    "",
  ...
  script: {
    ...
    surprise: {
      ...
      stars: [
        ...
        { name: "tus pasatiempos", text: "Te gusta escribir, tejer y la reposteria. Mmm lo de cocinar aun no se si me lo creo eh jaja ntc", x: 36, y: 76 },
        { name: "una última cosa", text: "Ya tienes una pagina mas para tu diario.Espero que sonrías cuando recuerdes esto.", x: 50, y: 48 },
      ],
